    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        reff.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                String nama_paket = dataSnapshot.child("kategoriTenaga").getValue().toString();
                String ppk_pjn = dataSnapshot.child("jabatan").getValue().toString();

                name.setText(nama);
                nip_.setText(nip);
                nama_pkt.setText(nama_paket);
                pp.setText(ppk_pjn);
            }
        ...
        if (requestSinglePermission()) {
            ...
            // = (TextView) findViewById((R.id.latitude_textview));
