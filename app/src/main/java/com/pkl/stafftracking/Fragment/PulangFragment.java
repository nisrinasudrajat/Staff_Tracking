...
public class PulangFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Query query = FirebaseDatabase.getInstance().getReference().child("User").child(userid).child("Kegiatan");

        FirebaseListOptions<Pulang> options = new FirebaseListOptions.Builder<Pulang>()
                .setLayout(R.layout.list_item_laporan)
                .setQuery(query, Pulang.class)
                .build();
        ...
        adapter = new FirebaseListAdapter(options) {
            ...
            protected void populateView(View v, Object model, int position) {
                ...
                Pulang pulang = (Pulang) model;
                hari.setText(pulang.getHari());
                tanggal.setText("   " + pulang.getTanggal());
                jam.setText("Anda pulang pukul " + pulang.getJam());
